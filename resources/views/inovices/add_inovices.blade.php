...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('inovices.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    {{ csrf_field() }}
                    {{-- 1 --}}
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="inputName" name="invoice_number" title="Please insert the bill number  " required>
                        </div>
                    ...
                    <p class="text-danger">type of attachments pdf, jpeg ,.jpg , png* </p>
                    <h5 class="card-title">Attachmemts</h5>
