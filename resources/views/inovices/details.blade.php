...
<div class="breadcrumb-header justify-content-between">
	<div class="my-auto">
		<div class="d-flex">
			<h4 class="content-title mb-0 my-auto">Bills list</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
				Bill details</span>
		</div>
	</div>
						...
						<div class=" tab-menu-heading">
							<div class="tabs-menu1">
								...
								<ul class="nav panel-tabs main-nav-line">
									<li><a href="#tab4" class="nav-link active" data-toggle="tab">Invoices Details</a> </li>
							...
							<div class="tab-content">
											...
											<table class="table table-striped" style="text-align:center">
												<tbody>
													...
													<tr>
														...
														<th scope="row">Comission amount </th>
								...
								<div class="tab-pane" id="tab6">
									...
									<div class="card card-statistics">
										...
										<div class="card-body">
											<p class="text-danger">Attachments type* pdf, jpeg ,.jpg , png </p>
											...
											<tbody>
												...
												<tr>
													...
													<td colspan="2">
														...
														<a class="btn btn-outline-success btn-sm" href="{{ url('View_file') }}/{{ $invoices->invoice_number }}/{{ $attachment->file_name }}" role="button"><i class="fas fa-eye"></i>&nbsp;
															Show</a>
														...
														<button class="btn btn-outline-danger btn-sm" data-toggle="modal" data-file_name="{{ $attachment->file_name }}" data-invoice_number="{{ $attachment->invoice_number }}" data-id_file="{{ $attachment->id }}" data-target="#delete_file">Delete</button>
		...
		<div class="modal-content">
			...
			<form action="{{route('delete_file')}}" method="post">
				...
				<div class="modal-body">
					<p class="text-center">
					<h6 style="color:red">?Are you sure of deleting this attachment</h6>
					</p>
