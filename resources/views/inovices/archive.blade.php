...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Bills</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Archived Bills </span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<script>
    window.onload = function() {
        ...
        notif({
            ...
            msg: "Your bill has been archived successfully",
            type: "success"
        })
    }
</script>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-id_invoice="{{ $invoice->id }}" data-target="#restore_file">Restore</a>
...
<div class="modal fade" id="delete_file" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('archive.destroy','$invoice->id_invoice')}}" method="post">
...
<!-- Restore bills -->
<div class="modal fade" id="restore_file" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Restore attachment</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{route('archive.store')}}" method="post">
                ...
                <div class="modal-body">
                    <p class="text-center">
                    <h6 style="color:green">?Are you sure of restoring this invoice</h6>
                    </p>
...
<script>
    $('#restore_file').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget)
        var id_invoice = button.data('id_invoice')
        var modal = $(this)
