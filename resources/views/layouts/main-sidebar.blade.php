...
<aside class="app-sidebar sidebar-scroll">
	...
	<div class="main-sidemenu">
		...
		<ul class="side-menu">
			<li class="side-item side-item-category">Billing Application</li>
			<li class="slide">
			...
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
					...
					</svg><span class="side-menu__label">BILLS</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ url('/' . $page='inovices') }}">Invoice list</a></li>
					<li><a class="slide-item" href="{{ url('/' . $page='inovices.Paid_Bill' ) }}">Paid bills</a></li>
					...
					<li><a class="slide-item" href="{{ url('/archive' . $page='') }}">Archived bills</a></li>
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">Bill Reports</a></li>
